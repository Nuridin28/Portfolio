...
export default function ProjectCard({ project }) {
  return (
    <div className="project-card flex flex-col font-[inter] border-2 border-white px-6 py-4 rounded-3xl shadow-lg shadow-slate-300 mt-10 ">
      ...
      <div className="project-card__btns flex justify-between gap-2 mt-8">
